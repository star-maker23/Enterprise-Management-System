...
public class EmsConfig {
    ...
    public void setFileBaseDir(String fileBaseDir) {
        EmsConfig.fileBaseDir = fileBaseDir  + File.separator + Constants.RESOURCE_PREFIX;
    }
    ...
    public void setApiPrefix(String apiDocsPathPrefix) {
        EmsConfig.apiPrefix = apiDocsPathPrefix;
    }
    ...
    public void setAddressEnabled(boolean addressEnabled) {
        EmsConfig.addressEnabled = addressEnabled;
    }
    ...
    public void setCaptchaType(String captchaType) {
        EmsConfig.captchaType = captchaType;
    }
    ...
    public void setRsaPrivateKey(String rsaPrivateKey) {
        EmsConfig.rsaPrivateKey = rsaPrivateKey;
    }
    ...
    public void setDemoEnabled(boolean demoEnabled) {
        EmsConfig.demoEnabled = demoEnabled;
    }
