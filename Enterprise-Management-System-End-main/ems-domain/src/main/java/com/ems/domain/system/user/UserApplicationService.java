package com.ems.domain.system.user;

import cn.hutool.core.convert.Convert;
import com.ems.common.core.page.PageDTO;
import com.ems.domain.common.cache.CacheCenter;
import com.ems.domain.common.command.BulkOperationCommand;
import com.ems.domain.common.dto.CurrentLoginUserDTO;
import com.ems.domain.system.post.dto.PostDTO;
import com.ems.domain.system.role.dto.RoleDTO;
import com.ems.domain.system.user.command.AddUserCommand;
import com.ems.domain.system.user.command.ChangeStatusCommand;
import com.ems.domain.system.user.command.ResetPasswordCommand;
import com.ems.domain.system.user.command.UpdateProfileCommand;
import com.ems.domain.system.user.command.UpdateUserAvatarCommand;
import com.ems.domain.system.user.command.UpdateUserCommand;
import com.ems.domain.system.user.command.UpdateUserPasswordCommand;
import com.ems.domain.system.user.db.SearchUserDO;
import com.ems.domain.system.user.dto.UserDTO;
import com.ems.domain.system.user.dto.UserDetailDTO;
import com.ems.domain.system.user.dto.UserProfileDTO;
import com.ems.domain.system.user.model.UserModel;
import com.ems.domain.system.user.model.UserModelFactory;
import com.ems.domain.system.user.query.SearchUserQuery;
