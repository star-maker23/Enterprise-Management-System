package com.ems.infrastructure.annotations.ratelimit;

import com.ems.infrastructure.annotations.ratelimit.implementation.MapRateLimitChecker;
import com.ems.infrastructure.annotations.ratelimit.implementation.RedisRateLimitChecker;
...
@Component
@Slf4j
@ConditionalOnExpression("'${ems.embedded.redis}' != 'true'")
