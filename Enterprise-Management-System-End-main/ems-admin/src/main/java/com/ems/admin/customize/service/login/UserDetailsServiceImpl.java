...
import com.ems.infrastructure.user.web.RoleInfo;
import com.ems.infrastructure.user.web.DataScopeEnum;
import com.ems.common.enums.common.UserStatusEnum;
 ...
 * @see com.ems.infrastructure.config.SecurityConfig#filterChain(HttpSecurity)
 * @author valarchie
 */
@Service
@Slf4j
