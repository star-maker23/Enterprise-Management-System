package com.ems.admin.customize.service.login;
...
import com.ems.common.constant.Constants.Captcha;
...
import com.ems.common.utils.ServletHolderUtil;
import com.ems.common.utils.i18n.MessageUtils;
import com.ems.domain.common.cache.GuavaCacheService;
import com.ems.domain.common.cache.MapCache;
import com.ems.domain.common.cache.RedisCacheService;
import com.ems.admin.customize.async.AsyncTaskFactory;
import com.ems.infrastructure.thread.ThreadPoolManager;
...
import com.ems.common.enums.common.LoginStatusEnum;
...
public class LoginService {
    ...
    public CaptchaDTO generateCaptchaImg() {
        ...
        if (isCaptchaOn) {
            ...
            // 生成验证码
            String captchaType = EmsConfig.getCaptchaType();
    ...
    public String decryptPassword(String originalPassword) {
        byte[] decryptBytes = SecureUtil.rsa(EmsConfig.getRsaPrivateKey(), null)
