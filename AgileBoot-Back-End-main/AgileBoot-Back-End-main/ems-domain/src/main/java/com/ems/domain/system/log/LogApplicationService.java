package com.ems.domain.system.log;

import com.ems.common.core.page.PageDTO;
import com.ems.domain.common.command.BulkOperationCommand;
import com.ems.domain.system.log.dto.LoginLogDTO;
import com.ems.domain.system.log.query.LoginLogQuery;
import com.ems.domain.system.log.dto.OperationLogDTO;
import com.ems.domain.system.log.query.OperationLogQuery;
import com.ems.domain.system.log.db.SysLoginInfoEntity;
import com.ems.domain.system.log.db.SysOperationLogEntity;
import com.ems.domain.system.log.db.SysLoginInfoService;
import com.ems.domain.system.log.db.SysOperationLogService;
