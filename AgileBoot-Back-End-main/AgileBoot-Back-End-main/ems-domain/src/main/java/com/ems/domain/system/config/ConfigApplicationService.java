package com.ems.domain.system.config;

import com.ems.common.core.page.PageDTO;
import com.ems.domain.common.cache.CacheCenter;
import com.ems.domain.system.config.command.ConfigUpdateCommand;
import com.ems.domain.system.config.dto.ConfigDTO;
import com.ems.domain.system.config.model.ConfigModel;
import com.ems.domain.system.config.model.ConfigModelFactory;
import com.ems.domain.system.config.query.ConfigQuery;
