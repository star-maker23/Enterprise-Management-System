...
-- 创建表 sys_asset 资产信息表
CREATE TABLE  app.sys_asset (
           asset_id serial8 PRIMARY KEY NOT NULL, -- 资产ID
           asset_name VARCHAR(128) NOT NULL, -- 资产名称
           asset_code VARCHAR(64) NOT NULL, -- 资产编码
