...
create sequence if not exists sys_asset_seq start with 1 increment by 1;
...
(
    ...
    asset_type    varchar(32)              null comment '资产类型',
...
CREATE ALIAS FIND_IN_SET FOR "com.ems.infrastructure.mybatisplus.MySqlFunction.findInSet";
